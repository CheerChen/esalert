...
func (l *LuaRunner) Do(c Context) (interface{}, bool) {
	if l.File != "" {
...
func RunInline(ctx Context, code string) (interface{}, bool) {
	c := cmd{
		ctx:    ctx,
		inline: code,
...
func RunFile(ctx Context, filename string) (interface{}, bool) {
	c := cmd{
		ctx:      ctx,
		filename: filename,
		retCh:    make(chan interface{}),
